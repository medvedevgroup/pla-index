...
struct darray {
    ...
    uint64_t bytes() const {
        return sizeof(m_positions) + essentials_arank::vec_bytes(m_block_inventory) +
               essentials_arank::vec_bytes(m_subblock_inventory) +
               essentials_arank::vec_bytes(m_overflow_positions);
    }
    ...
    void save(std::ostream &os) const{
        essentials_arank::save_pod(os, m_positions);
        essentials_arank::save_vec(os, m_block_inventory);
        essentials_arank::save_vec(os, m_subblock_inventory);
        essentials_arank::save_vec(os, m_overflow_positions);
    }

    void load(std::istream &is){
        essentials_arank::load_pod(is, m_positions);
        essentials_arank::load_vec(is, m_block_inventory);
        essentials_arank::load_vec(is, m_subblock_inventory);
        essentials_arank::load_vec(is, m_overflow_positions);
    }

    void save_fp(FILE* fp){
        fwrite(&m_positions, sizeof(m_positions), 1, fp);
        essentials_arank::save_vec_fp(fp, m_block_inventory);
        essentials_arank::save_vec_fp(fp, m_subblock_inventory);
        essentials_arank::save_vec_fp(fp, m_overflow_positions);
    }
    ...
    void load_fp(FILE* fp){
        ...
        essentials_arank::load_vec_fp(fp, m_block_inventory);
        essentials_arank::load_vec_fp(fp, m_subblock_inventory);
        essentials_arank::load_vec_fp(fp, m_overflow_positions);
    }
