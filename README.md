...
To build an `exact-pla` index with `21` size k-mer, default epsilon value (15), default shortcut array size (|D| = 2<sup>16</sup>), we will use the formatted fasta file and the built suffix array:
```shell
